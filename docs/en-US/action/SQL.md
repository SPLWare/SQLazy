...
Parameter: **db**
Corresponds to the database connection name in SQLazy configuration items, which includes necessary connection information such as URL, driver, username, password. Optional parameter; type is string, including expressions that evaluate to a string; parameter name cannot be omitted.
...
SQLazy: SQL "select * from Orders where Amount>1000 and Amount<=10000"; db orcl
Results:
