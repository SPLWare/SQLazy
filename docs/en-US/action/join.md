...
> Partial SQLazy code: join department_number; with department_table; department_number…  // Here the join column name is the same as the base column name, so it can be omitted.
