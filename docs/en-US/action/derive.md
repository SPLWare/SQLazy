...
SQLazy: derive OrderID , Amount as OriginalAmount, Amount*1.1
Result:
...
SQLazy: derive append Amount as OriginalAmount, Amount*1.1
Result:
...
SQLazy: derive append Amount as OriginalAmount, Amount*1.1; delete OrderDate
Result:
