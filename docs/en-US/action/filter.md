...
Parameter: **condition**
Conditional expression. If the current record makes the conditional expression true, keep that record. Required parameter; parameter name must be omitted. This parameter supports cross-row calculation and aggregation calculation, i.e., the expression can contain relative position calculations like F[i], F[a:b], and aggregate calculations like sum, average of a set.
> Example: filter records, condition: State = "New York" or State = "Texas"
SQLazy: filter (State = "New York" or State = "Texas")
Parameter: **delete**
...
> Example: delete records that meet the condition, conditional expression: State = "New York" or State = "Texas"
SQLazy: filter (State = "New York" or State = "Texas"); delete
Parameter: **partition**
...
SQLazy: filter (State = "New York" or State = "Texas"); partition Department