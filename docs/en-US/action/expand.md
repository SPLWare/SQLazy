...
Li Si	5-2		2
NLC: expand 2
Third form: When the list parameter is an expression that can generate a set, assuming the set length generated by the expression for the i-th record is Li, then the records of the focus table can be sequentially expanded by L1, L2, ... Li records.
> Duty_table originally has 2 records, where StartDate and EndDate are the duty start and end intervals, and DutyDay is the focus column. Data as follows:
Name	StartDate	EndDate	DutyDay
Zhang San	2021-01-01	2021-01-02
Li Si	2021-01-01	2021-01-03
Requirement: Expand each record into multiple records using the expression "periods(StartDate, EndDate)".
Expected result:
Name	StartDate	EndDate	DutyDay
Zhang San	2021-01-01	2021-01-02	2021-01-01
Zhang San	2021-01-01	2021-01-02	2021-01-02
Li Si	2021-01-01	2021-01-03	2021-01-01
Li Si	2021-01-01	2021-01-03	2021-01-02
Li Si	2021-01-01	2021-01-03	2021-01-03
NLC: expand periods(StartDate, EndDate)
