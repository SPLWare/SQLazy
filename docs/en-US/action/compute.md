...
sum, avg, count, icount, variance, std_deviation, max, min: understood by common sense. When the parameter value (enum value) of **[summary]** is count, the <formula> can be omitted, to comply with SQL conventions.
