...
SQLazy snippet: concat(15.2, "ok")		// result is "15.2ok"
...
SQLazy snippet: concat(15.2, "ok"; with " ")		// result is "15.2 ok"
...
SQLazy snippet: concat(15.2, "ok"; comma)		// result is "15.2,ok"
> Example: Specify both with and comma, comma wins and with is ignored.
SQLazy snippet: concat(15.2, "ok"; with " "; comma)		// result is still "15.2,ok" (with ignored)
...
SQLazy snippet: concat(15.2, "ok"; quote)		// result is "15.2\"ok\""
...
SQLazy snippet: concat(15.2, null, "ok", "", "yes"; comma; skip_empty)		// result is "15.2,ok,yes"
