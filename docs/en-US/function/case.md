...
SQLazy snippet: (year(order_test_date) case 2024 then "the year before last").
...
SQLazy snippet: (year(order_test_date) case 2024 then "the year before last", 2025 then "last year", 2026 then "this year")
...
SQLazy snippet: (year(order_test_date) case 2024 then "the year before last", 2025 then "last year", 2026 then "this year"; else "other year")
