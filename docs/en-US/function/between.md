...
SQLazy snippet: (order_amount between 1000, 10000) // returns true
...
SQLazy snippet: (1000 between 1000, 10000; left_open) // returns false
...
SQLazy snippet: (1000 between 1000, 10000; tri_state) // returns 0