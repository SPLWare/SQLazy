...
SQLazy snippet: string(3456.78) // result is "3456.78"
...
SQLazy snippet: string(3456.78; format "$#,##0.00") // result is "$3,456.78"
...
SQLazy snippet: string("a\tb"; escape) // result is "a\tb"
...
SQLazy snippet: string("a\tb"; quote) // result is "\"a\tb\""
...
SQLazy snippet: string(2009-02-23; format "MMM dd, yyyy"; language "en") // result is "Feb 23, 2009"