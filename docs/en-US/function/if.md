...
SQLazy snippet: if ((year(order_date)=2019 and order_amount>10000) then "2019 large order")
...
SQLazy snippet: if ((year(order_date)=2019 and order_amount>10000) then "2019 large order", (year(order_date)=2019 and order_amount>2000) then "2019 medium order", (year(order_date)=2019 and order_amount<=2000) then "2019 small order")
...
SQLazy snippet: if ((year(order_date)=2019 and order_amount>10000) then "2019 large order", (year(order_date)=2019 and order_amount>2000) then "2019 medium order", (year(order_date)=2019 and order_amount<=2000) then "2019 small order"; else "other year orders")
