...
SQLazy snippet: ("abcabcdef" replace from "a", to "China") // result is ChinabcChinabcdef
...
SQLazy snippet: ("abcabcdef" replace from "a", to "China"; first_only) // result is Chinabcabcdef
...
SQLazy snippet: ("abcabcdef" replace from "A", to "China"; nocase) // result is ChinabcChinabcdef
...
SQLazy snippet: ("abc'abc'def" replace from "a", to "China"; skip_quoted) // result is Chinabc'abc'def
...
SQLazy snippet: ("aaa,aab,aa" replace from "aa", to "AA"; whole) // result is aaa,aab,AA