...
Return: multiple data types. Parses <object_parameter> into an appropriate data type. By default, parses the entire string. Optionally parse only quoted content. By default, does not parse escape characters; optionally parse escape characters.
...
SQLazy snippet: ("10:20:30" parse) // result is time type 10:20:30
...
SQLazy snippet: ("\'sadsdxc\'+23" parse match_quote) // returns "\'sadsdxc\'"
...
SQLazy snippet: ("a\tb" parse escape) // result is "a\tb"
> Example: Parse "\\u4e2d\\u56fd", including escape characters.
SQLazy snippet: ("\\u4e2d\\u56fd" parse escape) // result is "中国"