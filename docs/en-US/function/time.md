...
Parameter **[precise]**: When converting the string <hour_or_time_string> to time, restrict precision to hour, minute, or second. Non-required parameter; type is enumeration; enumeration values: hour, minute, second; parameter name omitted.
> Example: Convert the string "08:30:50:640" to time with minute precision.
NLC snippet: time("08:30:50:640"; minute) // result is time 08:30:00